...
import type { PdfLanguage } from './HeroSection';

const TITLES: Record<PdfLanguage, string> = {
  it: 'Guida del Parco Archeologico di Saturo',
  en: 'Saturo Archaeological Park Guide',
  es: 'Guía del Parque Arqueológico de Saturo',
};
...
const PDFViewer: React.FC<PDFViewerProps> = ({ pdfUrl, isOpen, onClose, language }) => {
